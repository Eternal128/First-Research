...
📄 **[Read the paper → `paper/paper.pdf`](paper/paper.pdf)** (typeset, with figures) · [markdown source → `docs/paper.md`](docs/paper.md) · [the protocol → `docs/proposal.md`](docs/proposal.md)
...
| Paper | Complete — `paper/paper.pdf` (21 pp., 8 figures) and `docs/paper.md`; 126 numeric claims cross-checked against `results/` |
...
| Path | Contents |
|---|---|
| `paper/paper.tex`, `paper/paper.pdf` | The typeset manuscript; `make -C paper` rebuilds it |
| `paper/figures/` | The eight figures, regenerated by `scripts/14_make_figures.py` |
